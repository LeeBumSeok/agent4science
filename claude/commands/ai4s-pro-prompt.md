---
description: Generate a research-model discussion prompt to copy into the web app
allowed-tools: Bash, Read, Write, Edit, Grep, Glob
---
Generate the opening prompt for your web research model (e.g. GPT Pro, Claude/Fable).
